...
/**
 * Created by yanricheng on 16-12-21.
 */
public class KafkaMsgComponent {
    private Logger logger = LoggerFactory.getLogger(KafkaMsgComponent.class);
    private static String topic1 = "test";
    ...
    public void init() {
        logger.info("Start KafkaMessageListenerContainer");
    ...
    public void destroy() {
        ...
        logger.info("Stop KafkaMessageListenerContainer");
    }
